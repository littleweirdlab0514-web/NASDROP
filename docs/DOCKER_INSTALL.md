...
```text
ghcr.io/littleweirdlab0514-web/nasdrop:0.9.26-6
```
...
services:
  nasdrop:
    image: ghcr.io/littleweirdlab0514-web/nasdrop:0.9.26-6
...
docker pull ghcr.io/littleweirdlab0514-web/nasdrop:0.9.26-6
...
```sh
docker pull --platform linux/amd64 ghcr.io/littleweirdlab0514-web/nasdrop:0.9.26-6
docker save -o nasdrop-0.9.26-6-amd64.tar ghcr.io/littleweirdlab0514-web/nasdrop:0.9.26-6
```
...
```sh
docker load -i nasdrop-0.9.26-6-amd64.tar
docker compose up -d
```
...
**The wrong architecture is reported:** `docker image inspect ghcr.io/littleweirdlab0514-web/nasdrop:0.9.26-6 --format '{{.Architecture}}'` shows the local image architecture. Remove a manually imported image for the wrong CPU and pull the multi-platform GHCR tag again.
