(() => {
  ...
  const rows={
    ...
    gigafileKeyPrompt:['Enter the GigaFile download key.','GigaFile 다운로드 키를 입력하세요.','请输入 GigaFile 下载密钥。','GigaFileのダウンロードキーを入力してください。'],
