(() => {
  const messages = {
    en: {
      ...
      statusQueued:"Queued", statusReady:"Ready", statusDownloading:"Downloading", statusVerifying:"Merging and verifying", statusPaused:"Paused", statusCompleted:"Completed", statusFailed:"Error", statusCancelled:"Stopped",
    ...
    ko: {
      ...
      statusQueued:"대기 중", statusReady:"준비", statusDownloading:"다운로드 중", statusVerifying:"병합·검증 중", statusPaused:"일시정지", statusCompleted:"완료", statusFailed:"오류", statusCancelled:"중지됨",
    ...
    ja: {
      ...
      statusQueued:"待機中", statusReady:"準備完了", statusDownloading:"ダウンロード中", statusVerifying:"結合・検証中", statusPaused:"一時停止", statusCompleted:"完了", statusFailed:"エラー", statusCancelled:"停止済み",
    ...
    zh: {
      ...
      statusQueued:"等待中", statusReady:"准备就绪", statusDownloading:"下载中", statusVerifying:"合并并校验中", statusPaused:"已暂停", statusCompleted:"已完成", statusFailed:"错误", statusCancelled:"已停止",
